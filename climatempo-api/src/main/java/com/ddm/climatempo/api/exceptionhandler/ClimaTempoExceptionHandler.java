...
@ControllerAdvice
public class ClimaTempoExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> handleAPIException(APIException ex, WebRequest request) {
		...
		String mensagemUsuario = messageSource.getMessage("cidade.nao.encontrada", null, LocaleContextHolder.getLocale()); //poderia pegar local ingles e de onde estiver.
		String mensagemDesenvolvimento = ex.toString();
		List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvimento));
